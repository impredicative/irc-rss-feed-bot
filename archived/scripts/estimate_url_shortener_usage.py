...
print("Number of links created using all accounts are: " f"{num_links_created_monthly:.0f}/month, " f"{num_links_created_daily:.0f}/day, " f"{num_links_created_hourly:.1f}/hour")
