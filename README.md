# irc-rss-feed-bot
**irc-rss-feed-bot** is a dockerized Python 3.8 and IRC based RSS/Atom and scraped HTML/JSON/CSV feed posting bot.
...
* In the above service definition in `docker-compose.yml`:
  * `image`: Use a specific
  [versioned tag](https://hub.docker.com/r/ascensive/irc-rss-feed-bot/tags?ordering=last_updated), e.g. `0.9.40`.
