# irc-rss-feed-bot
**irc-rss-feed-bot** is an IRC based RSS/Atom and scraped HTML/JSON feed posting bot implemented in Python 3.7.
...
Providing multiple comma-separated tokens, perhaps as many as 15 free ones or sufficient commercial ones, is required.
...
* **`nick`**: IRC nick with which to connect and authenticate. If the nick is in use, it will be regained.
